...
//    @SaCheckPermission("monitor:cache:list")
    ...
    public R<Map<String, Object>> getInfo() throws Exception {
        ...
        if (connectionFactory == null) {
            ...
            info.setProperty("redis_version", "N/A");
            info.setProperty("used_memory_human", "0B");
            info.setProperty("connected_clients", "0");
            info.setProperty("total_commands_processed", "0");
            
            result.put("info", info);
            result.put("dbSize", 0L);
